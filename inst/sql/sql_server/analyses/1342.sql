-- 2342 Number of records by visit_detail_concept_id by age decile
INSERT INTO @results_database_schema.@results_table
SELECT
	242 AS analysis_id,
    vo.visit_detail_concept_id AS stratum_1,
    FLOOR((YEAR(vo.visit_detail_start_date) - p.year_of_birth) / 10) AS stratum_2,
...
GROUP BY
    ...
    FLOOR((YEAR(vo.visit_detail_start_date) - p.year_of_birth) / 10)
;